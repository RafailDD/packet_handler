...
2. `packet_handler_tb_sv.sv` and `Makefile.icarus`: Contains a **stand-alone SystemVerilog testbench** that verifies the logic by sending scenarios and catching data loss conditions, providing a runnable open-source testing pathway on Icarus Verilog.
